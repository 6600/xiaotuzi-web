  ...
  switch (autoScaleInfo.type) {
    ...
    case 'show': {
      ...
      for (var index = 0; index < boxList.length; index++) {
        ...
        var scale = window.innerWidth / autoScaleInfo.deviseW
        autoScaleInfo.zoom = scale
        box.style.transform = 'scale(' + autoScaleInfo.zoom + ', ' + autoScaleInfo.zoom + ')'
        box.style.transformOrigin = '0 0'
        box.parentNode.style.height = autoScaleInfo.deviseH * scale + 'px'
        box.parentNode.style.overflow = 'hidden'
        box.style.height = autoScaleInfo.deviseH + 'px'
